...
Solver input: `out/27S/ver18/27S_ver18.csv` (58 atomic classes, 80 rows)

Change baseline: `work/27S/runs/ver17/draft/starting.csv` (58 atomic classes, 80 rows)

Configuration version: `5854751b2bb5`
...
- Solver objective: -1155
- Best objective bound: -1625
- Solve time: 20.0124 seconds
- Candidate assignments: 5631
- Hard violations: 0
- Soft penalty: 50 (9 findings)
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | feasible | -1155 | -1625 | 20.0124 | 50 | 2 | 0 |
| 2 | feasible | -1150 | -1390 | 20.0046 | 50 | 2 | 0 |
| 3 | feasible | -1150 | -1600 | 20.0162 | 50 | 2 | 0 |
...
- [custom_rule] (10) MATH 2703-TC1: matches a custom dislike rule (weight 10)
