...
Change baseline: `work/27S/runs/ver14/draft/starting.csv` (58 atomic classes, 80 rows)

Configuration version: `00bf24d27527`

Ran 3 independent attempt(s), each with a 30s CP-SAT budget. Selected attempt 1 by lowest worst instructor overload, then lowest solver objective, then lowest reported soft penalty.

## Selected result

- Solver status: feasible
- Solver objective: -1045
- Best objective bound: -1550
- Solve time: 30.0073 seconds
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | feasible | -1045 | -1550 | 30.0073 | 20 | 2 | 0 |
| 2 | feasible | -1090 | -1540 | 30.0116 | 120 | 6 | 0 |
| 3 | feasible | -1045 | -1600 | 30.0121 | 20 | 2 | 0 |
