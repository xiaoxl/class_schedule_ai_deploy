...
Reconciliation snapshot: `work/27S/initial/reconciliation.toml`

Configuration version: `ed4141a303c5`
...
- Solver objective: -1170
- Best objective bound: -1170
- Solve time: 7.58193 seconds
- Candidate assignments: 8359
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | optimal | -1170 | -1170 | 7.58193 | 10 | 0 | 0 |

## Before and after

| Metric | Before | After |
|---|---:|---:|
| Hard violations | 15 | 0 |
| Soft penalty | 850 | 10 |
| Soft findings | 10 | 2 |
| Worst overload | 0 | 0 |
...
- **MATH 1003-007** instructor: `new_instructor` -> `Ballard, Kasey L.`
- **MATH 1003-007** time: `MWF 10:00am` -> `MWF 8:00am`
- **STAT 2163-004** instructor: `new_instructor` -> `Yousuf, Marium`
- **STAT 2163-004** time: `MWF 1:00pm` -> `MWF 11:00am`
